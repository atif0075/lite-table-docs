...
const __pageData = JSON.parse('{"title":"先進的な事例","description":"","frontmatter":{},"headers":[],"relativePath":"cn/advance-examples.md","filePath":"cn/advance-examples.md"}');
const __default__ = { name: "cn/advance-examples.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("cn/advance-examples.md");
