...
const __pageData = JSON.parse('{"title":"Advance Examples","description":"","frontmatter":{},"headers":[],"relativePath":"advance-examples.md","filePath":"advance-examples.md"}');
const __default__ = { name: "advance-examples.md" };
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="advance-examples" tabindex="-1">Advance Examples <a class="header-anchor" href="#advance-examples" aria-label="Permalink to &quot;Advance Examples&quot;">​</a></h1><p>The following examples are more advanced and are meant to be used as a reference for more complex use cases.</p><h2 id="grouping" tabindex="-1">Grouping <a class="header-anchor" href="#grouping" aria-label="Permalink to &quot;Grouping&quot;">​</a></h2>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("advance-examples.md");
