...
import { useDark, useMediaQuery, useWindowScroll, useScrollLock } from "@vueuse/core";
const fonts = "";
const vars = "";
const base = "";
const utils = "";
...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"VitePress","description":"A VitePress site","base":"/","head":[],"appearance":true,"themeConfig":{"logo":"/assets/logo.svg"},"locales":{"root":{"label":"English","lang":"en-US","link":"/","title":"Vue 3 Table Lite","description":"Light Weight, Faster","themeConfig":{"logo":"/assets/logo.svg","nav":[{"text":"Home","link":"/getting-started"},{"text":"Examples","link":"/advance-examples"}],"sidebar":[{"collapsed":false,"text":"Quick Start","items":[{"text":"Getting Started","link":"/getting-started"}]},{"collapsed":false,"text":"Usage","items":[{"text":"Default Mode","link":"/usage/default-mode"},{"text":"V-Slot Mode","link":"/usage/v-slot-mode"},{"text":"Static Mode","link":"/usage/static-mode"}]},{"collapsed":false,"text":"API Reference","items":[{"text":"Props","link":"/api-reference/props"},{"text":"Events","link":"/api-reference/events"},{"text":"Slots","link":"/api-reference/slots"}]},{"collapsed":false,"text":"Examples","items":[{"text":"Simple Examples","link":"/simple-examples"},{"text":"Advance Examples","link":"/advance-examples"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/linmasahiro/vue3-table-lite"}]}},"jp":{"label":"日本語","lang":"ja-JP","link":"/jp/","title":"Vue 3 テーブル Lite","description":"軽量、高速","themeConfig":{"logo":"/assets/logo.svg","nav":[{"text":"ホーム","link":"/jp/getting-started"},{"text":"例","link":"/jp/advance-examples"}],"sidebar":[{"collapsed":false,"text":"クイックスタート","items":[{"text":"はじめに","link":"/jp/getting-started"}]},{"collapsed":false,"text":"使用法","items":[{"text":"デフォルトモード","link":"/jp/usage/default-mode"},{"text":"V-Slot モード","link":"/jp/usage/v-slot-mode"},{"text":"静的モード","link":"/jp/usage/static-mode"}]},{"collapsed":false,"text":"API リファレンス","items":[{"text":"プロパティ","link":"/jp/api-reference/props"},{"text":"イベント","link":"/jp/api-reference/events"},{"text":"スロット","link":"/jp/api-reference/slots"}]},{"collapsed":false,"text":"例","items":[{"text":"シンプルな例","link":"/jp/simple-examples"},{"text":"高度な例","link":"/jp/advance-examples"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/linmasahiro/vue3-table-lite"}]}},"tw":{"label":"繁體中文","lang":"zh-TW","link":"/tw/","title":"Vue 3 表格 Lite","description":"輕量、高速","themeConfig":{"logo":"/assets/logo.svg","nav":[{"text":"首頁","link":"/tw/getting-started"},{"text":"範例","link":"/tw/advance-examples"}],"sidebar":[{"collapsed":false,"text":"快速入門","items":[{"text":"開始","link":"/tw/getting-started"}]},{"collapsed":false,"text":"使用方式","items":[{"text":"預設模式","link":"/tw/usage/default-mode"},{"text":"V-Slot 模式","link":"/tw/usage/v-slot-mode"},{"text":"靜態模式","link":"/tw/usage/static-mode"}]},{"collapsed":false,"text":"API 參考","items":[{"text":"屬性","link":"/tw/api-reference/props"},{"text":"事件","link":"/tw/api-reference/events"},{"text":"插槽","link":"/tw/api-reference/slots"}]},{"collapsed":false,"text":"範例","items":[{"text":"簡單範例","link":"/tw/simple-examples"},{"text":"高級範例","link":"/tw/advance-examples"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/linmasahiro/vue3-table-lite"}]}},"cn":{"label":"简体中文","lang":"zh-CN","link":"/cn/","title":"Vue 3 表格 Lite","description":"轻量、快速","themeConfig":{"logo":"/assets/logo.svg","nav":[{"text":"首页","link":"/cn/getting-started"},{"text":"示例","link":"/cn/advance-examples"}],"sidebar":[{"collapsed":false,"text":"快速入门","items":[{"text":"开始","link":"/cn/getting-started"}]},{"collapsed":false,"text":"使用方法","items":[{"text":"默认模式","link":"/cn/usage/default-mode"},{"text":"V-Slot 模式","link":"/cn/usage/v-slot-mode"},{"text":"静态模式","link":"/cn/usage/static-mode"}]},{"collapsed":false,"text":"API 参考","items":[{"text":"Props 属性","link":"/cn/api-reference/props"},{"text":"事件 Events","link":"/cn/api-reference/events"},{"text":"插槽 Slots","link":"/cn/api-reference/slots"}]},{"collapsed":false,"text":"示例","items":[{"text":"简单示例","link":"/cn/simple-examples"},{"text":"高级示例","link":"/cn/advance-examples"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/linmasahiro/vue3-table-lite"}]}}},"scrollOffset":90,"cleanUrls":false}'));
