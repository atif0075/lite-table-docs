...
const __pageData = JSON.parse('{"title":"先進的な事例","description":"","frontmatter":{},"headers":[],"relativePath":"jp/advance-examples.md","filePath":"jp/advance-examples.md"}');
const __default__ = { name: "jp/advance-examples.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("jp/advance-examples.md");
