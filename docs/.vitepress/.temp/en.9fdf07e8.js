const en = {
  component_description: "A simple and lightweight data table component for Vue.js 3. Features sorting, paging, row check, dynamic data rendering, supported TypeScript, and more.",
  ...
  default_mode_description: "If you are always use API to get rows data. choose this mode.",
  slot_mode: "V-slot mode",
  slot_mode_description: "If you are use API to get rows data and need use vue components on rendering. choose this mode.",
  static_mode: "Static mode",
  static_mode_description: "If you are not use API to get rows data. choose this mode.",
  ...
  props_is_static_mode_desc: "If you not need use ajax or axios to get any data. set TRUE.",
  ...
  props_is_re_search_desc: "If reload data, be set true (Not required on is-static-mode)",
  ...
  props_columns_display_desc: "You can customize display data in there. (html tag or Etc.)",
  ...
  props_page_desc: "If you want to control the page number yourself, use this to change the page number.",
  props_page_size_desc: "Default display the number of items on one page. In most cases no set required.",
  props_page_options_desc: "Option list for pages dropdown",
  props_grouping_key_desc: "If you want to use a grouping table, set the name of your grouping field.",
  props_has_group_toggle_desc: "Show group toggle if you're using a grouping table.",
  props_grouping_display_desc: "Customize grouping title display if you're using a grouping table.",
  ...
  events: "Events",
  events_do_search_desc: "Your search event. It will be automatically triggered after data sorting and paging.",
  events_do_search_hint: "It's required in default mode, and in static mode, it's not.",
  ...
  events_is_finished_desc: "Will be trigger this function after table rendering finished.",
  events_is_finished_elements_desc: "Pass by has `is-rows-el` class name's elements.",
  events_return_checked_rows_desc: "Will be call this function after table checkbox on checked.",
  events_return_checked_rows_rowsKey_desc: "Pass by checked row's key field name.",
  events_get_now_page_desc: "You can get now page no from this function.",
  events_get_now_page_pageNo_desc: "Pass by page no.",
  events_row_clicked_desc: "You can get row data from this function after row clicked.",
  events_row_clicked_rowData_desc: "Pass by row data.",
  events_row_toggled_desc: "You can get rows data and toggle state after toggled.",
  events_row_toggled_rows_desc: "Pass by grouping rows.",
  events_row_toggled_is_collapsed_desc: "Pass by collapse state.",
  slots: "Slots",
  slots_description: "This is option. But, If you enabled V-slot mode, You should be to write it.",
