      ...
      clone: function clone(o, visited) {
        ...
        switch (type) {
          case "Object":
            ...
            var clone2 = {};
            visited[_.util.objId(o)] = clone2;
            for (var key in o) {
              if (o.hasOwnProperty(key)) {
                clone2[key] = _.util.clone(o[key], visited);
              }
            }
            return clone2;
          case "Array":
            ...
            o.forEach(function(v, i) {
              clone2[i] = _.util.clone(v, visited);
            });
            return clone2;
        }
        return o;
...
var CodeHighlight = {
  render: function() {
    ...
    return _c("div", { ref: "codeBlock" }, [_c("pre", { class: _vm.languageClass }, [_c("code", [_vm._t("default")], 2)])]);
  },
  staticRenderFns: [],
  name: "code-highlight",
  props: {
...
var vue_code_highlight_esm_default = install;
export {
  CodeHighlight as component,
  vue_code_highlight_esm_default as default
};
//# sourceMappingURL=vue-code-highlight.js.map
